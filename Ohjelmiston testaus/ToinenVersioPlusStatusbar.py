...
# This file should be in the apps folder, it contains the password hash and salt:
url = "C:\\group_work\\texteditor\\password_hash.txt"
...
# Check and install the 'bcrypt' package
...
def avaa_tiedosto():
    ...
    if teksti_tiedosto:
        ...
        if login(url, password):
            ...
            messagebox.showerror("Virhe", "Salasana on väärä!")
